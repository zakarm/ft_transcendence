                ...
                <div className="row">
                    ...
                    <div className="col-md-6 align-self-center text-center">
                        ...
                        <div className='row  p-2 d-flex justify-content-center'>
                            <button className='sign-btn col-md-4 m-2' type='button' >SIGN UP</button>
                        ...
                        <div className='row text-start'>
                            ...
                            <div className='d-flex justify-content-around align-items-center'>
                                <button className='auth-btn col-md-2 m-2 p-3' type='button' ><FaGithub color='#FFEBEB'/></button>
                                <button className='auth-btn col-md-2 m-2 p-3' type='button' ><FaGoogle color='#FFEBEB'/></button>
                                <button className='auth-btn col-md-2 m-2 p-3' type='button' ><Si42 color='#FFEBEB'/></button>
                            </div>
                        </div>
                    </div>
                </div>
