...
function CountriesAndCities({ className = '', labelText1 = '', labelText2 = '', id = 'country' }: Props) {
  ...
  useEffect(() => {
    if (selectedCountry && data[selectedCountry as string]) {
      cities = data[selectedCountry as string].filter(
        (value, index) => data[selectedCountry as string].indexOf(value) === index,
      );
  ...
  return (
    <>
      <div className={`${className} flex-wrap flex-xl-nowrap`}>
        ...
        <div className={`${styles.inputHolder} row p-0 m-1`}>
          <div className={`col d-flex align-items-center  ${styles.inputContainer}`}>
            ...
            >
              <option className={`itim-font ${styles.input}`} hidden value={selectedCountry as string}>
      ...
      <div className={`${className} flex-wrap flex-xl-nowrap align-items-center`}>
        <label className={`col-8 col-sm-3 itim-font d-flex  p-0 m-0 ${styles.inputTitle}`} htmlFor={id}>
          {labelText2}
        </label>
        <div className={`${styles.inputHolder} row p-0 m-1`}>
          <div className={`col d-flex align-items-center  ${styles.inputContainer}`}>
            ...
            >
              <option className={`itim-font`} hidden value={selectedCity as string}>
