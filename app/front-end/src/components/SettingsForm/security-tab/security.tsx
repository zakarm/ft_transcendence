...
function GenerateInputFields() {
  ...
  return (
    <>
      {inputProps.slice(0, 2).map(({ inputId, labelText, placeholder, inputLength, inputType }: Props) => {
        return (
          <div key={inputId}>
            <GetInput
  ...
  return (
    <>
      <fieldset className="col-12 col-xxl-6 p-0 m-0 d-flex justify-content-center align-items-center h-100">
        <div className={`${Boolean(oldAccountValues['is_2fa_enabled']) ? '' : styles.qr_image} my-3`}>
