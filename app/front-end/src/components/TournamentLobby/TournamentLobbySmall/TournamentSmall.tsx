...
import { TournamentData, TournamentMatchProps, TournamentStageProps, TournamentUserProps } from '@/lib/game/Tournament';
...
const TournamentSmall: React.FC<TournamentData> = (data: TournamentData) => {
  ...
  const Semifinals = data.side1.semifinals.concat(data.side2.semifinals) as TournamentStageProps['matches'];
  return (
