...
export default function SideBar() {
    ...
    return (
        <div
            className={`${styles.side_container} d-inline-flex flex-column justify-content-around align-items-center vh-100 py-4 px-2`}
        >
            ...
            <div className="flex-grow-1 d-flex flex-column justify-content-around">
                <Link className="" href="/dashboard">
                    <TbAppsFilled
                        className={`${styles.side_icon} icon_0`}
                        color={activeIcon === 0 ? '#FF4755' : '#FFEBEB'}
                    />
                </Link>
                <Link className="" href="/game">
                    <IoGameController
                        className={`${styles.side_icon} icon_1`}
                        color={activeIcon === 1 ? '#FF4755' : '#FFEBEB'}
                    />
                </Link>
                <Link className="" href="/chat">
                    <IoChatbubble
                        className={`${styles.side_icon} icon_2`}
                        color={activeIcon === 2 ? '#FF4755' : '#FFEBEB'}
                    />
                </Link>
                <Link className="" href="/achievements">
                    <FaTrophy
                        className={`${styles.side_icon} icon_3`}
                        color={activeIcon === 3 ? '#FF4755' : '#FFEBEB'}
                    />
                </Link>
                <Link className="" href="/statistics">
                    <IoStatsChart
                        className={`${styles.side_icon} icon_4`}
                        color={activeIcon === 4 ? '#FF4755' : '#FFEBEB'}
                    />
                </Link>
                <Link className="" href="/settings">
                    <IoMdSettings
                        className={`${styles.side_icon} icon_5`}
            ...
            <div className="flex-grow-1 d-flex align-items-end pb-3">
                <IoMdLogOut
                    className={`${styles.side_icon} ${styles.icon_5}`}
                    color={activeIcon === 6 ? '#FF4755' : '#FFEBEB'}
