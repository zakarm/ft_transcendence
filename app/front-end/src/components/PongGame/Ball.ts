...
export default class Ball {
  ...
  update(ball_position_x: number, ball_position_z: number, ball_velocity_x: number, ball_velocity_z: number) {
  ...
  intersect(
    ...
    if (paddle1Box.intersectsSphere(ballSphere)) {
      if (
        ...
        this.mesh.position.z = paddle1.mesh.position.z + paddle1.depth / 2 + this.radius + 0.05;
        this.Velocityz *= -1;
      } else if (
        this.mesh.position.z < paddle1.mesh.position.z - paddle1.depth / 2 &&
        this.mesh.position.x < paddle1.mesh.position.x + paddle1.width / 2
        ...
        this.mesh.position.x = paddle1.mesh.position.x + paddle1.width / 2 + this.radius + 0.05;
        this.Velocityx *= -1;
      }
    }
    if (paddle2Box.intersectsSphere(ballSphere)) {
      if (
        ...
        this.mesh.position.z = paddle2.mesh.position.z + paddle2.depth / 2 + this.radius + 0.05;
        this.Velocityz *= -1;
      } else if (
        this.mesh.position.z < paddle2.mesh.position.z - paddle2.depth / 2 &&
        this.mesh.position.x > paddle2.mesh.position.x - paddle2.width / 2
        ...
        this.mesh.position.x = paddle2.mesh.position.x - paddle2.width / 2 - this.radius - 0.05;
        this.Velocityx *= -1;
      }
    }
    if (wall1Box.intersectsSphere(ballSphere) || wall2Box.intersectsSphere(ballSphere)) {
      this.Velocityz *= -1;
    }
  }
