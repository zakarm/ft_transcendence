      ...
      <div className={`row ${styles.player_card_container}`}>
        ...
        {body ? (
          body.toString().length <= 8 ? (
            <h2 className={`col-12 m-1 valo-font  font-color ${styles.player_card_body} d-flex align-items-center`}>
        ...
        >
          <img src={imgSrc} loading="lazy" style={{ objectFit: 'contain' }} className={`${styles.card_image}`} />
        </div>
      </div>
    </>
  );
