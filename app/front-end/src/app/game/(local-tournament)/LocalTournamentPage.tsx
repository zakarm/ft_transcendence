...
const LocalTournamentPage: NextPage = () => {
  ...
  const promoteWinner = (
    ...
    setFilteredTournamentData((prevState: TournamentData) => {
      ...
      const loserindex: string = round === 'finals' ? 'user' + (userIndex + 1) : 'user' + (userIndex === 0 ? 2 : 1);
  ...
  useEffect(() => {
    if (LocaltournamentData) {
      setFilteredTournamentData((prevState: any) => ({
        ...
        side1: {
          ...prevState.side1,
          quarterfinals: [LocaltournamentData.data.quatre_final.match1, LocaltournamentData.data.quatre_final.match2],
        ...
        side2: {
          ...prevState.side2,
          quarterfinals: [LocaltournamentData.data.quatre_final.match3, LocaltournamentData.data.quatre_final.match4],
