        ...
        <div className={`${styles.overlay_}`}>
            <div className={`${styles.dialog}`}>
                ...
                <div className={`${styles.content}`}>
                    ...
                    <p className={`${styles.p}`}>A point is scored when the opponent fails to return the ball and it passes their paddle.</p>
                    <h3 className={`${styles.semiTitle}`}>3 - Game Start:</h3>
                    <p className={`${styles.p}`}>The game starts with the ball placed in the center of the table. The ball moves automatically.</p>
                    ...
                    <p className={`${styles.p}`}>Players can pause the game at any time by pressing the 'Space' key. The game will resume when 'Space' is pressed again.</p>
                    <h3 className={`${styles.semiTitle}`}>2 - Remote Games:</h3>
                    <p className={`${styles.p}`}>
                        Each player has two pauses per match. To pause the game, press the 'Space' key. The game will resume when either player presses 'Space' again. Use pauses strategically to take short breaks or
                        regain focus.
                    </p>
                </div>
            </div>
