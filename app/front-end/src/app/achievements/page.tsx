  ...
  return (
    <div className={`${styles.achi_container} row p-1 m-1`}>
      {content.map(({ title, subTitle, imageURL, achieved }) => {
        return (
          <div className="col-12 col-md-6 col-xxl-4 d-flex justify-content-center" key={title}>
            <AchivementCard title={title} subTitle={subTitle} imageURL={imageURL} achieved={achieved}></AchivementCard>
          </div>
        );
      })}
    </div>
