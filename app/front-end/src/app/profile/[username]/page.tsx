                    ...
                    {user ? (
                      user.is_accepted ? (
                        <div className="row d-flex justify-content-center">
                          <div
                            className={`col-md-5 col-8 ${styles.btn}`}
                          ...
                          <div className={`col-md-5 col-8 ${styles.btn}`}>
                            <button
                              onClick={() => fetchUserState('friends-remove', 'Removed from friends', params.username)}
                            >
                              Remove
                            </button>
                          </div>
                        ...
                        <div className={`col-md-5 col-8 ${styles.btn}`}>
                          <button onClick={() => fetchUserState('friends-accept', 'added to friends', params.username)}>
                            Accept
                          </button>
                        </div>
                      )
                      ...
                      <div className={`col-md-5 col-8 ${styles.btn}`}>
                        <button onClick={() => fetchUserState('friends-add', 'Friend Request Sent', params.username)}>
                          Invite
                        </button>
                      </div>
                    )}
