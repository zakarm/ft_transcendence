                ...
                <div className={`row`}>
                  <div className={`col-12 col-md-12`}>
                    <h6 className={`${styles.med_titles} itim-font`}>
                      Welcome to our online ping pong paradise! Dive into the fast-paced world of table tennis with our
                      website, where players of all levels can connect, compete, and improve their skills. From casual
                      matches to intense tournaments, we've got everything you need to serve up some excitement!
                    </h6>
                  </div>
                  <div>
                  ...
                  <div className="col-6 d-flex align-items-end justify-content-end">
                    <Dropdown onClick={toggleDropdown}>
                      ...
                      <Dropdown.Menu show={dropdownOpen}>
                        <Dropdown.Item className="itim-font" onClick={() => handleDropdownSelect('day')}>
                          This Day
                        </Dropdown.Item>
                        <Dropdown.Item className="itim-font" onClick={() => handleDropdownSelect('month')}>
                          This Month
                        </Dropdown.Item>
                        <Dropdown.Item className="itim-font" onClick={() => handleDropdownSelect('year')}>
                          This Year
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
                  ...
                  <div className="col-6 d-flex align-items-end justify-content-end">
                    <Dropdown onClick={toggleDropdownGameStats}>
                      ...
                      <Dropdown.Menu show={dropdownOpenGameStats}>
                        <Dropdown.Item className="itim-font" onClick={() => handleDropdownSelect2('month')}>
                          This Month
                        </Dropdown.Item>
                        <Dropdown.Item className="itim-font" onClick={() => handleDropdownSelect2('3_months')}>
                          3 Months
                        </Dropdown.Item>
                        <Dropdown.Item className="itim-font" onClick={() => handleDropdownSelect2('year')}>
                          1 Year
                        </Dropdown.Item>
                      </Dropdown.Menu>
                    </Dropdown>
