...
def create_superuser():
    ...
    if user_count == 0:
        create_superuser_cmd = "python3 manage.py createsuperuser --noinput"
        subprocess.run(create_superuser_cmd.split(), text=True, check=True)
        time.sleep(0.3)
...
def create_achievements():
    cmd = "python3 tools/scripts/achievements.py --noinput"
